# Local association study for the 22q11.2 region in the duplication-only model with traits linked to the 22q11.2 region (HPO)
...
fwrite(data.frame(hm$SNP), "/scratch/beegfs/FAC/FBM/DBC/zkutalik/default_sensitive/mzamario/Traits_22q112_region_CNV_GWAS/Continuous/duplication_only/intermediate_files/high_missingness.txt", col.names = F, row.names = F, quote = F, sep = "\t")


#################################################
### STEP 2: Prepare PLINK input #################

# PLINK file set - duplication-only model
plink_file <- paste0("/scratch/beegfs/FAC/FBM/DBC/zkutalik/default_sensitive/mzamario/CNV_GWAS/plink_input/duplication_only/ukb_cnv_chr", chr)
...
HM_file <- "/scratch/beegfs/FAC/FBM/DBC/zkutalik/default_sensitive/mzamario/Traits_22q112_region_CNV_GWAS/Continuous/duplication_only/intermediate_files/high_missingness.txt"

# Output file
output_file <- paste0("/scratch/beegfs/FAC/FBM/DBC/zkutalik/default_sensitive/mzamario/Traits_22q112_region_CNV_GWAS/Continuous/duplication_only/intermediate_files/dup", chr, ":", start, ":", end)
