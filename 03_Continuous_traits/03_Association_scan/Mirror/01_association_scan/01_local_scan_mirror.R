# Local association study for the 22q11.2 region in the mirror model with traits linked to the 22q11.2 region (HPO)
...
# Here we will perform a GWAS with all probes in the region of interest, only excluding high missingness probes 
...
fwrite(data.frame(hm$SNP), "/scratch/beegfs/FAC/FBM/DBC/zkutalik/default_sensitive/mzamario/Traits_22q112_region_CNV_GWAS/Continuous/mirror/intermediate_files/high_missingness.txt", col.names = F, row.names = F, quote = F, sep = "\t")


#################################################
### STEP 2: Prepare PLINK input #################

# PLINK file set - mirror model
...
HM_file <- "/scratch/beegfs/FAC/FBM/DBC/zkutalik/default_sensitive/mzamario/Traits_22q112_region_CNV_GWAS/Continuous/mirror/intermediate_files/high_missingness.txt"

# Output file
output_file <- paste0("/scratch/beegfs/FAC/FBM/DBC/zkutalik/default_sensitive/mzamario/Traits_22q112_region_CNV_GWAS/Continuous/mirror/intermediate_files/mirror", chr, ":", start, ":", end)
