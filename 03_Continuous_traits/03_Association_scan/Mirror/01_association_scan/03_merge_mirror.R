...
all_pheno$file <- gsub("/scratch/beegfs/FAC/FBM/DBC/zkutalik/default_sensitive/mzamario/Traits_22q112_region_CNV_GWAS/Continuous/mirror/intermediate_files/mirror22:18400000:22500000.", "", all_pheno$file)
...
fwrite(all_pheno, "/scratch/beegfs/FAC/FBM/DBC/zkutalik/default_sensitive/mzamario/Traits_22q112_region_CNV_GWAS/Continuous/mirror/gwas_results/continuous_trait22q112_associations_mirror.txt", col.names = T, row.names = F, quote = F, sep = "\t")
...
fwrite(sig_all, "/scratch/beegfs/FAC/FBM/DBC/zkutalik/default_sensitive/mzamario/Traits_22q112_region_CNV_GWAS/Continuous/mirror/gwas_results/continuous_trait22q112_sig_associations_mirror.txt", col.names = T, row.names = F, quote = F, sep = "\t")
...
fwrite(nominal, "/scratch/beegfs/FAC/FBM/DBC/zkutalik/default_sensitive/mzamario/Traits_22q112_region_CNV_GWAS/Continuous/mirror/gwas_results/continuous_trait22q112_nominal_associations_mirror.txt", col.names = T, row.names = F, quote = F, sep = "\t")
